...
local function mk_command_handler(func)
  return function(cmd, ctx)
    ...
    client.request("workspace/executeCommand", {
      ...
      arguments = { { uri = args.uri or curbuf_uri() } },
    })
  end
end
...
local default_config = {
  ...
  on_init = function(client)
    ...
    client.checkDocument = function(_) end
...
function M.setup(user_config)
  ...
  vim.lsp.commands = vim.tbl_deep_extend("force", vim.lsp.commands, {
  ...
  user_config = vim.tbl_extend("force", internal_config, user_config)
